// ignore_for_file: use_key_in_widget_constructors, prefer_typing_uninitialized_variables, must_be_immutable, avoid_print

import 'package:carousel_slider/carousel_slider.dart';
import 'package:flutter/material.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:beat_bash/screens/eventcontainer.dart';
import 'package:beat_bash/screens/profile.dart';
import 'package:beat_bash/screens/create_event.dart';

class Homepage extends StatefulWidget {
  var userType;

  Homepage({required Key key, @required this.userType}) : super(key: key);
          ...
          SliverList(
            delegate: SliverChildBuilderDelegate(
              (context, index) => EventContainer(
                  data: events[index], documentSnapshot: events[index]),
              childCount: events.length,
            ),
          ),
        ],
